...
class Auth extends CI_Controller {
    ...
    public function registration(){
        ...
        $this->form_validation->set_rules('cpassword', 'Password', 'required|trim|min_length[3]|matches[password]');
        ...
        private function _sendEmail($token, $type){
            ...
            $config['smtp_user'] = 'gusticahyax@gmail.com';
            $config['smtp_pass'] = 'HujAnKePepet2gobloklu!';
            ...
            $this->email->from('gusticahyax@gmail.com', 'Gusti Cahya');
            ...
            if($user){
                ...
                if($user_token){    
                    ...
                    if(time() - $user_token['date_created'] < (60*60*24)){
                        ...
                        $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
                            User activation failed! Token expired!
                            </div>');
                        redirect('auth');
                    }
                }else{
                    $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
                    User activation failed! Wrong Token!
                    </div>');
                redirect('auth');
                }
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
                    User activation failed! Wrong Email!
                    </div>');
                redirect('auth');
            }
        }
